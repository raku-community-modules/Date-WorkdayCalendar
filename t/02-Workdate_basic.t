...
lives_ok(
    { my $wd = Workdate.new(year=>2012, day=>20, month=>01) },
...
lives_ok(
    { my $wd = Workdate.new( DateTime.new(year=>2011, month=>12, day=>01, hour=>15, minute=>30) ) },
    'Constructor from a DateTime'
);
lives_ok(
    { my $wd = Workdate.new( Date.new(year=>2011, month=>12, day=>01) ) },
...
lives_ok(
    { my $wd = Workdate.new(year=>2012, day=>20, month=>01, calendar=>$calendar) },
...
lives_ok(
    { my $wd = Workdate.new( DateTime.new(year=>2011, month=>12, day=>01, hour=>15, minute=>30), $calendar ) },
    'Constructor from a DateTime, with a calendar specified'
);
lives_ok(
    { my $wd = Workdate.new( Date.new(year=>2011, month=>12, day=>01), $calendar ) },
